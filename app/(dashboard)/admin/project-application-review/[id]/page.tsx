...
const projectDetail = {
  ...
  partnerInfo: "剑桥大学（University of Cambridge）成立于1209年，是世界顶尖公立研究型大学，在多个世界大学排名中稳居前三位。剑桥大学工程学院在电力系统、智能电网、新能源技术等领域具有世界级的研究实力和教学水平，与我校电气工程学科有着长期的合作基础。本次合作方为剑桥大学工程学院国际交流部，联系人：Dr. John Smith，联系邮箱：international@eng.cam.ac.uk。",
