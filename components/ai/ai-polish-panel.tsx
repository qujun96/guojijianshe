...
const presetPolishedContent: Record<string, { original: string; polished: string }[]> = {
  ...
  overseasExperience: [
    {
      original: "去过日本旅游",
      polished: "2024年8月，本人随家人前往日本进行为期10天的文化交流之旅，期间游览了东京、京都、大阪等主要城市，深入了解了日本的历史文化和现代社会发展。此次经历培养了本人的跨文化交际能力，增强了独立生活的信心，为今后的海外学习奠定了良好基础。"
    },
    {
      original: "没有出国经历",
